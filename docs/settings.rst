...
.. doctest::
    ...
    Trying example []
    Found satisfying example [-30412, -68, 69532283562786725019046231690057241840, 1938465594]
    Shrunk example to [-30412, -68, 69532283562786725019046231690057241840, 1938465594]
    Shrunk example to [-4788571865503079353]
    Shrunk example to [-4788571865503079353]
    Shrunk example to [-4788571865503079353]
    Shrunk example to [-1114926269]
    Shrunk example to [17012]
    Shrunk example to [66]
    Shrunk example to [1]
    Shrunk example to [3]
    Shrunk example to [-2]
    Shrunk example to [-1]
